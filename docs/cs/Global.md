...
Nastavte jazyk pro provoz Z-Mod.
...
- `SAVE_Z-Mod_DATA ZCONTROL_Z=10` - Uložit výšku Z. Pokud nechcete povolit pauzu, nastavte `SAVE_Z-Mod_DATA ZCONTROL_Z=230`
...
Získat globální parametry/příznaky Z-Mod.
Po spuštění se v konzoli zobrazí uložené parametry aplikované za běhu.

`Fluidd` -> `Makra` -> `Hlavní` -> `Z-Mod PARAMETRY`
...
Uložit globální parametry/příznaky Z-Mod (aplikují se při každém tisku).
...
- Přejděte do `Fluidd` -> `Makra` -> `Systém` -> `SAVE Z-Mod PARAMETERS`, vyberte parametr, upravte ho a klikněte na `SEND`.
- Alternativně zadejte příkazy přímo do konzole Fluidd, např. `SAVE_Z-Mod_DATA CLOSE_DIALOGS=2`.
...
Příklad: `SAVE_Z-Mod_DATA ALLOWED_TOOL_COUNT=4`
...
Příklad: `SAVE_Z-Mod_DATA SCAN_FILE_COLORS=0`
...
Příklad: `SAVE_Z-Mod_DATA COLOR_MENU_1_BASED=1`
...
Příklad: `SAVE_Z-Mod_DATA AUTO_ASSIGN_COLORS=0`
...
Příklad: `SAVE_Z-Mod_DATA MIDI_START=Pain-Shut-your-mouth.mid`
...
Příklad: `SAVE_Z-Mod_DATA PRECLEAR=0`
...
Příklad: `SAVE_Z-Mod_DATA PRINT_LEVELING=1`

---
##### USE_KAMP

Použít adaptivní mesh (KAMP) místo plného meshe podložky, kde je to možné: 0 (ne), 1 (ano) (0).
Doporučuje se nastavit `SAVE_Z-Mod_DATA CLEAR=LINE_PURGE`, aby se umístění čištění shodovalo s KAMP meshem.

Příklad: `SAVE_Z-Mod_DATA USE_KAMP=1`
...
Příklad: `SAVE_Z-Mod_DATA MESH_TEST=0`
...
Příklad: `SAVE_Z-Mod_DATA FORCE_MD5=1`
...
Příklad: `SAVE_Z-Mod_DATA DISABLE_SKEW=1`
...
Příklad: `SAVE_Z-Mod_DATA LOAD_ZOFFSET=0`
...
Příklad: `SAVE_Z-Mod_DATA DISABLE_PRIMING=0`
...
Příklad: `SAVE_Z-Mod_DATA CLEAR=LINE_PURGE`
...
Příklad: `SAVE_Z-Mod_DATA MIDI_END=Pain-Shut-your-mouth.mid`
...
Příklad: `SAVE_Z-Mod_DATA CLOSE_DIALOGS=2`
...
Příklad: `SAVE_Z-Mod_DATA STOP_MOTOR=1`
...
Příklad: `SAVE_Z-Mod_DATA AUTO_REBOOT=0`
...
Příklad: `SAVE_Z-Mod_DATA MOTION_SENSOR=1`
...
Příklad: `SAVE_Z-Mod_DATA SILENT=0`
...
Příklad: `SAVE_Z-Mod_DATA AUTOINSERT=0`
...
Příklad: `SAVE_Z-Mod_DATA ALWAYS_FULL_COLOR_CHANGE=0`
...
Příklad: `SAVE_Z-Mod_DATA USE_TRASH_ON_PRINT=0`
...
Příklad: `SAVE_Z-Mod_DATA REMOVE_FILAMENT=1`
...
Příklad: `SAVE_Z-Mod_DATA FIX_SCV=1`
...
Spusťte `SAVE_Z-Mod_DATA WIFI=1`
...
- Načítání dat SWAP (SWAP je na EMMC, která pracuje rychlostí 10 MB/s; data SWAP během výpočtů shaperu mohou dosáhnout 25MB). Řešení: Vypněte SWAP, pokud máte 256MB RAM pomocí `SAVE_Z-Mod_DATA USE_SWAP=0`.
...
Příklad: `SAVE_Z-Mod_DATA FIX_E0011=1`
...
- Pokud jste vypnuli swap na FF5M/FF5MPro.
  ...
  Povolte swap, pokud je vypnutý: `SAVE_Z-Mod_DATA USE_SWAP=1`
...
Příklad: `SAVE_Z-Mod_DATA FIX_E0017=1`
...
Příklad: `SAVE_Z-Mod_DATA LED=50`
...
Příklad: `SAVE_Z-Mod_DATA MIDI_ON=Pain-Shut-your-mouth.mid`
...
Příklad: `SAVE_Z-Mod_DATA NEW_SAVE_CONFIG=0`
...
Příklad: `SAVE_Z-Mod_DATA USE_SWAP=1`
...
Příklad: `SAVE_Z-Mod_DATA CHINA_CLOUD=0`
...
Pro aktualizaci továrního firmwaru povolte čínské cloudy pomocí `SAVE_Z-Mod_DATA CHINA_CLOUD=1`, restartujte a pokračujte v aktualizaci.
...
Příklad: `SAVE_Z-Mod_DATA NICE=20`
...
Příklad: `SAVE_Z-Mod_DATA DISPLAY_OFF_TIMEOUT=120`
...
Příklad: `SAVE_Z-Mod_DATA PRO_POWEROFF_TIMEOUT=10`

---

##### SAVE_MOONRAKER

- 0 - Načíst rozložení tlačítek maker ze Z-Mod (výchozí).
- 1 - Povolit ukládání změn tlačítek maker lokálně ve Fluidd/Moonraker.

Lokálně uložená makra jsou uložena v samostatné sekci.

Příklad: `SAVE_Z-Mod_DATA SAVE_MOONRAKER=1`
...
Příklad: `SAVE_Z-Mod_DATA SAVE_FILAMENT_SENSORS=1`