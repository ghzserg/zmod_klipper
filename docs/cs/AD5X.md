...
##### Režim Nopoop (`SAVE_Z-Mod_DATA USE_TRASH_ON_PRINT=0`)
...
##### Režim odpadu řízený slicerem (`SAVE_Z-Mod_DATA USE_TRASH_ON_PRINT=2`)
...
Nejlepší je zkrátit životnost nativního displeje na 10 sekund: ```SAVE_Z-Mod_DATA DISPLAY_OFF_TIMEOUT=10```