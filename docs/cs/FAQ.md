...
- ZMOD používá nativní obrazovku nebo GuppyScreen/HelixScreen místo KlipperScreen.
...
*   [KlipperScreen](https://klipperscreen.readthedocs.io/en/latest/) - obrazovka pro tiskárnu. V ZMOD se místo KlipperScreen používá nativní obrazovka nebo GuppyScreen/HelixScreen.
...
*   Konfigurace sítě přes iwd/wpa_supplicant (v případě GuppyScreen/HelixScreen) - v ZMOD se konfigurace sítě provádí přes nativní obrazovku, spuštění sítě je možné i bez nativní obrazovky.
