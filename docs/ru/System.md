...
Если не понимаете, как [восстановить конфиги и прошивку MCU](/ru/Native_FW/#установка-полной-прошивки-на-ad5x), не запускайте.

- [Восстановить родной Klipper через флешку](/ru/Native_FW/#fix_klipper)
