...
* Если испорльзуется Klipper 13 на AD5X. В этом случае можно вернуться на родной Klipper выполнив `UPDATE_MCU FORCE=12`
* Если используется fuzzu skin и процессор не успевает просчитать траекторию движения. Тогда нужно отключить fuzzu skin или подобрать его параметры.
