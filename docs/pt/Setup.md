...
3. Coloque o arquivo de [Native firmware](/en/Native_FW/) na pasta raiz da unidade flash USB
    ...
    - [AD5X-1.1.7-1.1.0-3.0.6-20250912.tgz](https://github.com/ghzserg/FF/releases/download/R/AD5X-1.1.7-1.1.0-3.0.6-20250912-Factory.tgz) para AD5X
...
11. **Abra o IP da impressora no navegador**
    ...
    Se a interface da Web não abrir, o firmware nativo desativou o mod. Para ativá-lo, é necessário gravar no arquivo flash USB [AD5X-ENABLE-zmod.tgz](https://github.com/ghzserg/FF/releases/download/R/AD5X-ENABLE-zmod.tgz) e [activate mod](/pt/Native_FW/#ad5x-enable-zmodtgz).
