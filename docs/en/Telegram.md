...
**If the printer and server are on the same network, SSH is optional. Refer to the [telegram.conf](https://github.com/ghzserg/z_ff5m/blob/1.7/telegram/telegram.conf) configuration file.**
...
Install the Telegram bot with [one command](https://github.com/ghzserg/z_ff5m/blob/1.7/telegram/telegram.sh) on Debian:
...
1. Install Docker
2. Download [docker-compose.yml](https://github.com/ghzserg/z_ff5m/blob/1.7/telegram/docker-compose.yml) and [telegram.conf](https://github.com/ghzserg/z_ff5m/blob/1.7/telegram/telegram.conf) [Sample-config](https://github.com/nlef/moonraker-telegram-bot/wiki/Sample-config)
...
6. Install [ff5m.sh](https://github.com/ghzserg/z_ff5m/blob/1.7/telegram/ff5m.sh)
...
1. Copy [docker-compose.yml](https://github.com/ghzserg/z_ff5m/blob/1.7/telegram/docker-compose.yml) from the printer’s `mod/telegram/` directory.
...
4. Place [docker-compose.yml](https://github.com/ghzserg/z_ff5m/blob/1.7/telegram/docker-compose.yml) here.
...
6. Copy [telegram.conf](https://github.com/ghzserg/z_ff5m/blob/1.7/telegram/telegram.conf) from `mod/telegram/` to `config/` and edit it.
...
Edit the [docker-compose.yml](https://github.com/ghzserg/z_ff5m/blob/1.7/telegram/docker-compose.yml) file.
...
Edit the file [docker-compose.yml](https://github.com/ghzserg/z_ff5m/blob/1.7/telegram/docker-compose.yml)
